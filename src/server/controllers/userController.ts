...
class UserController{
     ...
     */
    public async registration(request: Request, response: Response, next: NextFunction): Promise<Response | void> {
        try {
     ...
     * @param next - следующая middleware функция
     */
    public async logout(request: Request,response: Response,next: NextFunction): Promise<Response | void> {
        try {
     ...
     * @param next - следующая middleware функция
     */
    public async refresh(request: Request, response: Response, next: NextFunction): Promise<Response | void> {
        try {
     ...
     * @param next - следующая middleware функция
     */
    public async getUsers(request: Request, response: Response, next: NextFunction): Promise<Response | void> {
        try {
